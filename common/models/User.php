...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            ['role', 'in', 'range' => [self::ROLE_AUTHOR, self::ROLE_BANNED]],
        ];
    }
    ...
    {
        $this->password_hash = $password ? Yii::$app->security->generatePasswordHash($password) : $this->getOldAttribute('password_hash');
    }
     ...
     * @return array
     */
    public static function namedRoles(): array
    {
        return [
